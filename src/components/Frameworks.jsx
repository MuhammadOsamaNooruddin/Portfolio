...
import { AnimatedBeam } from "./OrbitingCircles";

const Circle = React.forwardRef(({ className, children, style }, ref) => (
  <div
    ref={ref}
    style={style} // <-- IMPORTANT: this applies left/top for positioning
    className={twMerge(
      "absolute flex size-12 items-center justify-center rounded-full border-2 bg-white p-3 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]",
      className
    )}
  >
    {children}
...
export function Frameworks() {
  ...
  const itemRefs = Array.from({ length: iconEntries.length }, () => useRef(null));
  ...
  return (
    ...
    >
      ...
      <Circle
        ref={centerRef}
        className="z-20 size-16 left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2"
      >
        <Icons.openai />
      </Circle>

      {/* Orbiting Icons */}
      {iconEntries.map(([key, IconComponent], i) => {
        const angle = (i / iconEntries.length) * 2 * Math.PI;
